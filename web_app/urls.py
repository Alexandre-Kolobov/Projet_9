...
urlpatterns = [
    ...
    path(
        'change_password/',
        authentication.views.PasswordChangeView.as_view(template_name='authentication/change_password.html'),
        name='password_change'
        ),  # renvoi par defaut vers "password_change_done"
    ...
    path(
        'home/tickets/view_create_ticket_and_review/',
        blog.views.view_create_ticket_and_review,
        name='view_create_ticket_and_review'
        ),

    path(
        'home/review/<int:review_id>/update_ticket_review/',
        blog.views.update_ticket_and_review,
        name='update_ticket_and_review'
        ),
    path('home/review/<int:review_id>/update_review/', blog.views.update_review, name='update_review'),
